...
const projects = [
  {
    ...
    icon: <Science sx={{ color: '#64ffda', fontSize: 20 }} />,
  },
  {
    ...
    icon: <Translate sx={{ color: '#64ffda', fontSize: 20 }} />,
  },
  {
    ...
    icon: <Healing sx={{ color: '#64ffda', fontSize: 20 }} />,
  },
  {
    ...
    icon: <Group sx={{ color: '#64ffda', fontSize: 20 }} />,
  },
];
